...
use rig::{
    ...
    providers::doubao::{self, DOUBAO_EMBEDDING_TEST_240715, DOUBAO_PRO_32K},
...
async fn main() -> Result<()> {
    ...
    let doubao_client = doubao::Client::from_env();
    ...
    let model = doubao_client.embedding_model(DOUBAO_EMBEDDING_TEST_240715);
    ...
    // Create RAG agent
    let rag_agent = doubao_client
        .agent(DOUBAO_PRO_32K)
